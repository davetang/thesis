...
\section{The role of bioinformatics in transcriptomics}

\begin{itemize}
   \item Bermuda principles - a commitment that was made in Bermuda (February 1996) by an international assortment of genome-research sponsors to the principles of public sharing and the rapid release of human genome sequence information
   \item Wet bench research goes hand in hand with bioinformatics
   \item BEDTools \cite{pmid20110278}
   \item BWA \cite{pmid19451168}
   \item FASTQ \cite{pmid20015970}
   \item SAMtools \cite{pmid19505943}
