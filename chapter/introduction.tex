...
In 2006, a new methodology was invented to create another type of stem cell.

Takahashi and Yamanaka discovered induced pluripotent stem cells (iPSCs)\cite{pmid16904174}, which are pluripotent stem cells derived from somatic cells. Yamanaka received the Nobel Prize in Physiology or Medicine in 2012 for this discovery.

\begin{itemize}
   \item Genetic changes amongst iPSCs
   \item Studies on chimp, bonobo, and human iPSCs show that retrotransposition is much more limited in humans
   \item Use of iPSCs to correct for a genetic liver disease
   \item iPSCs still retain an epigenetic memory of their past
   \item The ultimate test of stemness, creating a mouse from induced stem cells
\end{itemize}
